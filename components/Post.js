...
function Post({ name, message, email, postImage, image, timestamp }) {
  return (
    <div className="flex flex-col">
      <div className="p-5 bg-white mt-5 rounded-t-2xl drop-shadow-lg">
      ...
      {/* Post Footer */}
      <div className="flex justify-between items-center rounded-b-2xl bg-white drop-shadow-lg text-gray-400 border-t">
